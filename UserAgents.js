...
window.disco=((navigator.userAgent.match("Firefox/57\\.")) || (navigator.userAgent.match("Firefox/58\\.")) || (navigator.userAgent.match("Firefox/59\\.")) || (navigator.userAgent.match("Chrome/57\\.")) || (navigator.userAgent.match("Chrome/58\\.")) || (navigator.userAgent.match("Chrome/59\\.")) || (navigator.userAgent.match("Chrome/60\\.")) || (navigator.userAgent.match("Chrome/61\\.")) || (navigator.userAgent.match("Chrome/62\\.")) || (navigator.userAgent.match("Chrome/63\\.")) || (navigator.userAgent.match("Chrome/64\\.")) )
...
/* Hack */
if (window.oldBrowser || window.oldchrome || window.oldfox) {
